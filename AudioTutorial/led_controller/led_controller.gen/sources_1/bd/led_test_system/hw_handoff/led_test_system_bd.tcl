...
proc create_root_design { parentCell } {
  ...
  set led_controller_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:led_controller:1.0 led_controller_0 ]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
