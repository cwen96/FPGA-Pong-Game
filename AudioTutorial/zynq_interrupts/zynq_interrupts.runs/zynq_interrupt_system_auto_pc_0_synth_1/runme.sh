...
HD_PWD='C:/Users/cjw18/Desktop/GitHub/ensc-452/AudioTutorial/zynq_interrupts/zynq_interrupts.runs/zynq_interrupt_system_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_auto_pc_0.tcl
