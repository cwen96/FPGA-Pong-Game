...
HD_PWD='C:/Users/cjw18/Desktop/GitHub/ensc-452/AudioTutorial/adventures_with_ip/adventures_with_ip.runs/ip_design_lfsr_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_lfsr_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_lfsr_0_1.tcl
