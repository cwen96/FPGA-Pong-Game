...
proc create_root_design { parentCell } {
  ...
  set lfsr_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:lfsr:1.0 lfsr_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins lfsr_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net lfsr_0_rand32_out [get_bd_pins lfsr_0/rand32_out] [get_bd_pins ps7_0_axi_periph/S00_AXI_wdata]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins lfsr_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lfsr_0/S00_AXI/S00_AXI_reg] -force
