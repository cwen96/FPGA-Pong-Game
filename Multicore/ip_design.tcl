...
sfu.ca:user:display_game_objects:1.0\
ac.uk:user:led_controller:1.0\
sfu.ca:user:lfsr:1.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:processing_system7:5.5\
user.org:user:vga_controller:1.0\
xilinx.com:ip:xlconcat:2.1\
xilinx.com:user:zed_audio_ctrl:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: display_game_objects_0, and set properties
  set display_game_objects_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:display_game_objects:1.0 display_game_objects_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {120.0000} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins display_game_objects_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins lfsr_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins display_game_objects_0/PIXEL_CLOCK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins vga_controller_0/pixel_clk]
  connect_bd_net -net display_game_objects_0_VGA_B_OUT [get_bd_ports VGA_B] [get_bd_pins display_game_objects_0/VGA_B_OUT]
  connect_bd_net -net display_game_objects_0_VGA_G_OUT [get_bd_ports VGA_G] [get_bd_pins display_game_objects_0/VGA_G_OUT]
  connect_bd_net -net display_game_objects_0_VGA_R_OUT [get_bd_ports VGA_R] [get_bd_pins display_game_objects_0/VGA_R_OUT]
  connect_bd_net -net led_controller_0_LEDs_out [get_bd_ports LEDs_out] [get_bd_pins led_controller_0/LEDs_out]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins display_game_objects_0/s00_axi_aclk] [get_bd_pins led_controller_0/s00_axi_aclk] [get_bd_pins lfsr_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk] [get_bd_pins vga_controller_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_125M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins display_game_objects_0/s00_axi_aresetn] [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins lfsr_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
  connect_bd_net -net vga_controller_0_VGA_B [get_bd_pins display_game_objects_0/VGA_B] [get_bd_pins vga_controller_0/VGA_B]
  connect_bd_net -net vga_controller_0_VGA_G [get_bd_pins display_game_objects_0/VGA_G] [get_bd_pins vga_controller_0/VGA_G]
  connect_bd_net -net vga_controller_0_VGA_HS [get_bd_ports VGA_HS] [get_bd_pins display_game_objects_0/VGA_HS] [get_bd_pins vga_controller_0/VGA_HS]
  connect_bd_net -net vga_controller_0_VGA_R [get_bd_pins display_game_objects_0/VGA_R] [get_bd_pins vga_controller_0/VGA_R]
  connect_bd_net -net vga_controller_0_VGA_VS [get_bd_ports VGA_VS] [get_bd_pins display_game_objects_0/VGA_VS] [get_bd_pins vga_controller_0/VGA_VS]
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs display_game_objects_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lfsr_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs zed_audio_ctrl_0/S_AXI/reg0] -force
