...
EAStep vivado -log ip_design_display_game_objects_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_display_game_objects_0_0.tcl
