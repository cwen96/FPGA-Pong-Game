...
HD_PWD='C:/Users/cryst/Documents/ensc-452/AudioTutorial/adventures_with_ip/adventures_with_ip.runs/ip_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_auto_pc_0.tcl
