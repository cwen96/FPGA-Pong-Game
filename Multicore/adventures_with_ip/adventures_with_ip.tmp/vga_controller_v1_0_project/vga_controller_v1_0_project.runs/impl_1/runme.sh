...
HD_PWD='c:/users/dumpherv/desktop/452project/ensc-452/multicore/adventures_with_ip/adventures_with_ip.tmp/vga_controller_v1_0_project/vga_controller_v1_0_project.runs/impl_1'
cd "$HD_PWD"
