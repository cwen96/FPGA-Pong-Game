...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display_game_objects_v1_0_S00_AXI is
  ...
  signal xCount : STD_LOGIC_VECTOR ( 7 downto 5 );
...
\VGA_R_OUT[3]_i_679\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\VGA_R_OUT[3]_i_683\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\VGA_R_OUT_reg[3]_i_375\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2 downto 0) => xCount(7 downto 5)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN ip_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
