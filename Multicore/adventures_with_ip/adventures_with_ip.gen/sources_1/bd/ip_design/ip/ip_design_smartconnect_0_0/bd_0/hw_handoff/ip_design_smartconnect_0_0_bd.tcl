...
################################################################
# This is a generated script based on design: bd_09e1
#
...
proc create_hier_cell_i_nodes { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net i_aw_node_M_AXIS_ARB [get_bd_intf_pins i_aw_node/M_AXIS_ARB] [get_bd_intf_pins i_w_node/S_AXIS_ARB]
...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S01_SC_AR_1 [get_bd_intf_pins S01_SC_AR] [get_bd_intf_pins ar_la_in_swbd/S01_SC]
  connect_bd_intf_net -intf_net S01_SC_AW_1 [get_bd_intf_pins S01_SC_AW] [get_bd_intf_pins aw_la_in_swbd/S01_SC]
  connect_bd_intf_net -intf_net S01_SC_W_1 [get_bd_intf_pins S01_SC_W] [get_bd_intf_pins w_la_in_swbd/S01_SC]
  ...
  connect_bd_intf_net -intf_net b_la_in_swbd_M01_SC [get_bd_intf_pins M01_SC_B] [get_bd_intf_pins b_la_in_swbd/M01_SC]
  ...
  connect_bd_intf_net -intf_net r_la_in_swbd_M01_SC [get_bd_intf_pins M01_SC_R] [get_bd_intf_pins r_la_in_swbd/M01_SC]
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000082800000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SINGLE_ISSUING {1} \
   CONFIG.SSC000_ROUTE {0b1001} \
   CONFIG.SSC001_ROUTE {0b1011} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_map_M00_ACLK [get_bd_pins clk_map/M00_ACLK] [get_bd_pins m00_exit_pipeline/aclk] [get_bd_pins m00_nodes/m_axi_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m00_sc2axi/aclk] [get_bd_pins switchboards/m_sc_aclk]
  connect_bd_net -net clk_map_M00_ARESETN [get_bd_pins clk_map/M00_ARESETN] [get_bd_pins m00_exit_pipeline/aresetn] [get_bd_pins m00_nodes/m_axi_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins switchboards/m_sc_aresetn]
